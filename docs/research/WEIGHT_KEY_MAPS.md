...
Read-only probes of /opt/verisafe/models/* — source of truth for arch vendoring (P1 tasks 1.2–1.4).

## AASIST — /opt/verisafe/models/aasist/best_model.pth (3.79 GB)
...
## EFFORT ×3 — /opt/verisafe/models/effort/{chameleon,ffpp,genimage}/effort_*.pth (1.21 GB each)
...
## HAVIC ×2 — /opt/verisafe/models/havic/best_ft/best_ft_model.pth (859 MB) + pt200/pt_model.200.pth (973 MB)
