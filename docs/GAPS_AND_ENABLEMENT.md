...
| `vt` (VirusTotal) | ✅ **LIVE 2026-08-21** — key provisioned, T4.1 probe executed: file path verified end-to-end through project client (EICAR → 65/75 malicious, empty file → 0/75); URL domain path verified (wicar 16-17/91-92, google 0/91). Caveat Finding E: exact-url `/urls/{id}` lookup flaky-404s; client honestly degrades to `low` + note. Evidence: `docs/research/VT_LIVE_EVIDENCE.md` | free-tier quota (500/day) |
