...
class HAVIC_FT(nn.Module):
    ...
    def forward(self, audio=None, video=None, is_training=True):
        ...
        # feature extraction
        video_3, video_6, video_9, video_12 = self.visual_encoder(video, ids_keep=None, apply_cls_tokens=True, use_hierarchical=True)
        audio_3, audio_6, audio_9, audio_12 = self.audio_encoder(audio, ids_keep=None, apply_cls_tokens=True, use_hierarchical=True)
