...
import numpy as np
from ._timm_shim import to_2tuple, DropPath  # vendored shim replaces timm.models.layers
from ._timm_shim import Mlp  # vendored shim replaces timm.models.vision_transformer
