...
from vishwas.model_archs._rawbmamba_vendor.stubs import GenerationMixin
from vishwas.model_archs._rawbmamba_vendor.config_mamba import MambaConfig
from vishwas.model_archs._rawbmamba_vendor.cpu_ops import (
    RMSNorm as RMSNorm_shim, layer_norm_fn as layer_norm_fn_cpu,
    rms_norm_fn as rms_norm_fn_cpu)
from vishwas.model_archs._rawbmamba_vendor import mamba_simple as _ms
from vishwas.model_archs._rawbmamba_vendor.mamba_simple import Mamba, Block
...
def load_state_dict_hf(*a, **k):
    raise NotImplementedError("hf loading not vendored")
from vishwas.model_archs._rawbmamba_vendor.myBlocks import CONV, My_Residual_block, My_SERes2Net_block
