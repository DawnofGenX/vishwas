...
registry (:func:`vishwas.model_adapters._arch_aware_load`) consults
:func:`vishwas.model_archs.get_arch` LAZILY at load time.
...
class ArchSpec:
    ...
    ``weight_env`` (e.g. ``"VISHWAS_AASIST_WEIGHTS"``).  Instances may also be
