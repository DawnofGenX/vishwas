...
def build_interpretation_prompt(evidence_json: dict, doc_kind: str, extra_context: str = "") -> tuple[str, str, int]:
    ...
    sysp = (
        "You are Vishwas's risk-interpreter. You NEVER decide trust yourself. "
...
class LLMClient:
    ...
    def __init__(self,
                 ...
                 max_tokens: int = 200):
        self.base_url = (base_url or os.environ.get("VISHWAS_LLM_BASE_URL", "")).rstrip("/")
        self.api_key = api_key or os.environ.get("VISHWAS_LLM_API_KEY", "")
        self.model = model or os.environ.get("VISHWAS_LLM_MODEL", "qwen2.5-7b-instruct")
        ...
        # VISHWAS_LLM_USER_AGENT when a host needs something specific.
        self.user_agent = os.environ.get(
            "VISHWAS_LLM_USER_AGENT",
