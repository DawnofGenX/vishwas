...
defaults on this i5-8250U box (VISHWAS_FFMPEG_THREADS, default 2).
"""
...
FFMPEG = os.environ.get("VISHWAS_FFMPEG_BIN", "ffmpeg")
FFPROBE = os.environ.get("VISHWAS_FFPROBE_BIN", "ffprobe")
THREADS = int(os.environ.get("VISHWAS_FFMPEG_THREADS", "2"))   # thermal-safe cap
