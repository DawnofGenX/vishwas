...
(``VERISAFE_RAG_DIGEST_DIR``, default ``<repo>/docs/research/data``).
...
def _default_digest_dir() -> Path:
    """Catalog dir: VERISAFE_RAG_DIGEST_DIR or <repo>/docs/research/data."""
    env = os.environ.get("VERISAFE_RAG_DIGEST_DIR")
    if env:
        return Path(env)
