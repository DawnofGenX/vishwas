...
=================================
Checkpoint : /opt/verisafe/models/rawbmamba/rawbmamba_bset.pt
...
class RawBMambaSpec(ArchSpec):
    ...
    name = "fakemamba"
    weight_env = "VERISAFE_FAKEMAMBA_WEIGHTS"
    implemented = True
...
def get_arch() -> RawBMambaSpec:
    """Registry hook for verisafe.model_adapters._arch_aware_load."""
