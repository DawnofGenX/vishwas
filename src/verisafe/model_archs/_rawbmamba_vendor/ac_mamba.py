...
from verisafe.model_archs._rawbmamba_vendor.stubs import GenerationMixin
from verisafe.model_archs._rawbmamba_vendor.config_mamba import MambaConfig
from verisafe.model_archs._rawbmamba_vendor.cpu_ops import (
    RMSNorm as RMSNorm_shim, layer_norm_fn as layer_norm_fn_cpu,
    rms_norm_fn as rms_norm_fn_cpu)
from verisafe.model_archs._rawbmamba_vendor import mamba_simple as _ms
from verisafe.model_archs._rawbmamba_vendor.mamba_simple import Mamba, Block


def load_config_hf(*a, **k):  # hf helpers unused on this host
    raise NotImplementedError("hf loading not vendored")
def load_state_dict_hf(*a, **k):
    raise NotImplementedError("hf loading not vendored")
from verisafe.model_archs._rawbmamba_vendor.myBlocks import CONV, My_Residual_block, My_SERes2Net_block
from torch.autograd import Variable
RMSNorm, layer_norm_fn, rms_norm_fn = RMSNorm_shim, layer_norm_fn_cpu, rms_norm_fn_cpu
...
class MambaLMHeadModel(nn.Module, GenerationMixin):
    ...
    def __init__(
        ...
        fused_add_norm = config.fused_add_norm and False  # CPU vendored: triton fused path unavailable
