...
QUARANTINE_ROOT = Path(os.environ.get("VERISAFE_QUARANTINE", str(Path.home() / "verisafe" / "quarantine")))
AUDIT_LOG = Path(os.environ.get("VERISAFE_AUDIT_LOG", str(QUARANTINE_ROOT / ".." / "logs" / "purge_audit.log")))
STALE_TTL_S = int(os.environ.get("VERISAFE_STALE_TTL_S", 7200))
